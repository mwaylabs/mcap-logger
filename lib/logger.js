...
function Logger(options) {
    ...
    assert(options.baseUrl, 'Missing parameter options.baseUrl');
...
Logger.prototype.poll = function (uuid) {
    ...
    this.longPollingXhr = this._request({
        url: this.URL + 'gofer/system/liveLog?uuid=' + uuid,
        method: 'GET',
        dataType: 'json',
...
function resolveLevel(nameOrNum) {
    if (typeof nameOrNum === 'string') {
        return levelFromName[nameOrNum.toLowerCase()];
    } else {
        return nameOrNum;
    }
}
...
Logger.prototype.registerLogger = function (options) {
    ...
    // the log level
    var level = typeof options.level !== 'undefined' ? options.level : TRACE;
    url += 'level=' + level;
...
Logger.prototype.getLoggerInformation = function (name) {
    ...
    return this._request({
        url: this.URL + 'gofer/loggerConfiguration/rest/logger/loggerConfigurations/' + name + '?computeDerived=true',
        method: 'GET',
        dataType: 'json',
        contentType: 'application/json'
    });
...
Logger.prototype._request = function (options) {
    ...
    request[options.method.toLocaleLowerCase()](options, function (error, response, body) {
        if (error) {
            dfd.reject(error);
            return;
        }
